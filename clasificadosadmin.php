...
$consulta = "SELECT codigo, tipo, precio, correo, telefono, localidad FROM servicios";
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <form class="form-inline mt-2 mt-md-0">
        ...
        <br><br>
        <p><h4 class="text-center text-dark"><span class="badge badge-primary">Servicios en el sistema</span></h4>
