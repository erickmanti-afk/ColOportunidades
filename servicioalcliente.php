      ...
      <div class="carousel-item active" style="text-align:center;">
        ...
        <div class="container" style="text-align:center;">
          <div class="carousel-caption text-left" style="text-align:center;">
            ...
            <p style="text-align:center;">Da un click en el siguiente boton para ponerte en contacto con nosotros.</p>
            <p style="text-align:center;">Espera una pronta respuesta dentro de las 24 horas del día</p>
            <p style="text-align:center;">En este formulario vas a poder enviarnos tus peticiones PQRSD</p>
              <br>
              
              <p style="text-align:center;"><a class="btn btn-primary" href="peticiones.php" role="button">Contactanos.</a></p>
              <p style="text-align:center;"><a class="btn btn-primary" href="satisfaccion.html" role="button">ENCUESTA DE SATISFACCIÓN</a></p>
              <br>
              <br>
              <br>
          </div>
 ...
 <br><br>
  ...
  <div class="container marketing">
    <h1 style="text-align:center;">VIDEO TUTORIAL</h1>
      <br>
    <iframe width="700" height="350" src="https://www.youtube.com/embed/jUTeCcZzO64" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
